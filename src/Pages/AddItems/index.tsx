...
export function AddItems() {
  ...
  useEffect(() => {
    console.log('theType Changed:', theType)
  }, [theType])
    ...
    <div className="apptop">
      ...
      <div className="maingrid">
        ...
        <div className="usergrid">
          <Setup collection={theType.col.i} barcode={theType.barcode}
            setCol={(e: any, i: number) => setTheType({ ...theType, col: e })}
            setBarcode={(e: string, i: number) => setTheType({ ...theType, barcode: e })}
          />

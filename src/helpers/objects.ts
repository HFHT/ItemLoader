...
export const catCabType = [
  { Bath: { col: ['home-improvement', 'cabinets'], item: [{ '24 inch Vanity': { i: 2085 } }, { '30 inch Vanity': { i: 2085 } }, { '36 inch Vanity': { i: 2085 } }, { '48 inch Vanity': { i: 2085 } }, { '60 inch Vanity': { i: 2085 } }, { '72 inch Vanity': { i: 2085 } }], wood: finish.Wood, finish: '', color: finish.Paint, seo: seo.Cabinet } },
  ...
  { Storage: { col: ['home-improvement', 'cabinets'], item: [{ Chest: { i: 2082 } }, { 'Garage Cabinet': { i: 0 } }, { 'Rolling Cabinet': { i: 0 } }, { 'Tool Chest': { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Cabinet } },

]
export const catDoorType = [
  { 'Interior Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'Exterior Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'Security Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'Sliding Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'French Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'Pocket Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'Louvered Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
  { 'Bi-fold Door': { col: ['home-improvement', 'doors-windows'], item: [{ 'pre-hung door': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }, { 'door slab': { a: [attr.DoorWidth, attr.DoorHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Door } },
]
...
export const catWindType = [
  ...
  { 'Security Window': { col: ['home-improvement', 'doors-windows'], item: [{ 'Storm Window': { a: [attr.WindowWidth, attr.WindowHeight], i: 0 } }, { 'Security Window': { a: [attr.WindowWidth, attr.WindowHeight], i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Window, seo: seo.Window } },
...
export const catFurnType = [
  ...
  { Bathroom: { col: ['furniture', 'bathroom'], item: [{ Cabinet: { i: 0 } }, { 'Bathroom Mirror': { i: 0 } }, { 'Bath Organizer': { i: 0 } }, { 'Shelving': { i: 0 } }, { 'Vanity': { i: 2070 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, fabric: finish.Fabric, seo: seo.Furniture } },
  ...
  { Office: { col: ['furniture', 'office-furniture'], item: [{ Bookcase: { i: 0 } }, { Credenza: { i: 0 } }, { Desk: { i: 0 } }, { 'File Cabinet': { i: 2076 } }, { 'Office Chair': { i: 0 } }, { 'Printer Stand': { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, fabric: finish.Fabric, seo: seo.Furniture } },
  ...
  { Sectional: { col: ['furniture', 'living-room'], item: [{ 'Right Chair': { i: 0 } }, { 'Armless Chair': { i: 0 } }, { 'Left Chair': { i: 0 } }, { 'Ottoman': { i: 0 } }, { 'Corner Chair': { i: 0 } }, { 'Chaise': { i: 0 } }, { 'Love Seat': { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, fabric: finish.Fabric, seo: seo.Furniture } },
...
export const catHouseType = [
  { 'Art & Decor': { col: ['furniture', 'art-home-decor'], item: [{ Art: { i: 0 } }, { 'Plastic Plant': { i: 0 } }, { 'Silk Plant': { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Furniture } },
  { 'Tableware': { col: ['furniture', 'art-home-decor'], item: [{ Dinnerware: { i: 0 } }, { Drinkware: { i: 0 } }, { Serveware: { i: 0 } }, { Silverware: { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Furniture } },
  { 'Organization': { col: ['furniture', 'art-home-decor'], item: [{ Basket: { i: 0 } }, { Bath: { i: 0 } }, { Closet: { i: 0 } }, { Entryway: { i: 0 } }, { Kitchen: { i: 0 } }, { Jewelry: { i: 0 } }, { Office: { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Furniture } },
  { 'Entertainment': { col: ['furniture', 'art-home-decor'], item: [{ Books: { i: 0 } }, { Movies: { i: 0 } }, { Music: { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Furniture } },
  { 'Supplies': { col: ['home-improvement', 'building-materials'], item: [{ Cleaning: { i: 0 } }, { Pool: { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Furniture } },
  { 'Sporting Goods': { col: ['furniture', 'sporting-goods'], item: [{ Bicycle: { i: 0 } }, { Binoculars: { i: 0 } }, { Boat: { i: 0 } }, { Camping: { i: 0 } }, { Exercise: { i: 0 } }, { Fishing: { i: 0 } }, { GPS: { i: 0 } }, { Sports: { i: 0 } }], wood: finish.Wood, finish: '', color: finish.Paint, metal: finish.Metal, seo: seo.Furniture } },
]

export const catFloorType = [
  { Flooring: { col: ['flooring', 'home-improvement'], item: [{ 'Laminate Flooring': { s: true, i: 0 } }, { 'Hardwood Flooring': { s: true, i: 0 } }, { 'Tile Flooring': { s: true, i: 0 } }, { 'Vinyl Flooring': { s: true, i: 0 } }], mfg: '', pwr: '', wood: finish.Wood, finish: '', color: finish.Paint, metal: '', seo: seo.Floor } },

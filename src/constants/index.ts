...
export const CONST_GPT_PROD = 'Write an informative, two or three sentences, with a maximum of 156 characters, product description for {products} include keywords: {condition} with {flaw}, {seo},  {pieces}, {sqft}, {attr1}, {attr2}, {fabric}, {finish}'

export const CONST_GPT_TITLE = 'Write a tiny product title with a maximum of 62 characters, {seo} {fabric} {finish} {pieces} {mfg} {products} {sqft}'

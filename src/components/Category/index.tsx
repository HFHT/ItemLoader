        ...
        <div className="cattype">
            {isOpen &&
                <>
                    ...
                    <Product title='Material:' isOpen={theResult.prod !== '' || theResult.prods.length > 0} products={selectFinishes(theRoom)} onClick={(e: any, i: any) => setTheResult({ ...theResult, material: e })} />
                    <Product title='Finish:' isOpen={theResult.material !== '' && theResult.material !== ' ' && theResult.material !== 'Color'} products={whichFinish(theResult.material, theRoom)} onClick={(e: any, i: any) => setTheResult({ ...theResult, finish: e })} />
